...
const barOptions = {
  ...
  scales: {
    ...
    y: {
      ...
      grid: { color: '#f0f0f0', borderDash: [2, 3] },
...
.kpi-title { display: flex; align-items: center; gap: 6px; font-size: 13px; font-weight: 500; color: #595959; white-space: nowrap; }
...
.kpi-value { text-align: center; font-size: 34px; line-height: 1; font-weight: 700; color: #262626; font-variant-numeric: tabular-nums; }
...
.kpi-foot.muted { color: #8c8c8c; font-weight: 500; }
...
.heatmap-table { border-collapse: collapse; width: 100%; font-size: 13px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; border-radius: 8px; overflow: hidden; }
.heatmap-table th, .heatmap-table td { border: 1px solid #e8e8e8; padding: 10px 8px; text-align: center; white-space: nowrap; }
.corner-th { background: #f0f0f0; color: #262626; font-weight: 800; font-size: 13px; min-width: 140px; }
.col-th { background: #f0f0f0; color: #262626; font-weight: 800; font-size: 12px; min-width: 90px; max-width: 160px; overflow: hidden; text-overflow: ellipsis; }
.row-th { background: #f8f8f8; font-weight: 700; color: #262626; min-width: 140px; max-width: 200px; word-break: break-word; font-size: 13px; }
.heat-cell { min-width: 80px; font-weight: 600; font-size: 12px; transition: all 0.2s ease; color: #262626; cursor: default; }
...
/* Tooltip */
.heat-tooltip { position: fixed; z-index: 1000; background: #fff; padding: 14px 18px; border-radius: 8px; box-shadow: 0 8px 24px rgba(0,0,0,0.12); font-size: 12px; min-width: 200px; pointer-events: none; border: 1px solid #f0f0f0; }
...
.tt-row b { font-weight: 700; font-size: 14px; color: #1890ff; }
.c-red { color: #e84c3d !important; }
.c-yellow { color: #faad14 !important; }
.c-green { color: #52c41a !important; }

/* Modal */
.modal-loading, .modal-error, .modal-empty { text-align: center; padding: 40px; color: #8c8c8c; }
