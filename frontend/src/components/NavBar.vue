  ...
  <nav class="nav">
    <div class="nav-inner">
      ...
      <div class="nav-links">
        ...
        <router-link to="/failure-analysis">Failure Analysis</router-link>
      ...
      <div class="nav-date">{{ store.reportDate || 'Loading...' }}</div>
    </div>
  </nav>
</template>
...
.nav-badge {
  background: #f0f2f5; color: #8e99a8;
...
.nav-date {
  ...
  padding: 4px 12px; background: #f0f2f5;
